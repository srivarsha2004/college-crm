!(function (e, t) {
  ...
  function s(e, t, n) {
    ...
    return "string" == typeof n ? (r.innerHTML = n) : null != n && b(r, n), r;
  }
  function E(e) {
    e = e.trim();
  ...
  function F(e, t, n, r) {
    var i,
      ...
      s = W([
        ...
        0,
        1 +
          ((-(7 + W([t, 0, (o = 7 + (i = n) - r)]).getUTCDay() - i) % 7) +
            o -
            1),
      ]),
      a = V(e),
  ...
  function ve(e, t) {
    ...
    return (
      e.end &&
        ((i = V(e.end)),
        (n = e.end.valueOf() - i.valueOf()) && n >= ee(t) && (i = _(i, 1))),
      ...
      ($e.prototype.formatRange = function (e, t, n) {
        var r,
          ...
          l =
            ((r = e.marker),
            (i = t.marker),
            (o = n.calendarSystem).getMarkerYear(r) === o.getMarkerYear(i)
          ...
          v = (function (e, t, n, r) {
            for (var i = 0; i < e.length; ) {
              ...
              for (var a = e.substr(i), l = 0; l < n.length; ) {
                ...
                l = d + r.length;
                var u = n.substr(l);
                if (s === c && a === u) return { before: s, after: a };
              }
            }
            return null;
          })(c, h, u, f),
  ...
  var ut =
      ...
      d &&
        ...
        r
          ? Q(o, (s = ge(i.end, r, a, n.granularity)))
            ...
            : this.mutate({ startDelta: o, endDelta: s, standardProps: l })
          : ((l.hasEnd = !1),
            this.mutate({ datesDelta: o, standardProps: l })));
    }),
    ...
    Object.defineProperty(pt.prototype, "source", {
      get: function () {
        ...
        return e
          ? new dt(this._calendar, this._calendar.state.eventSources[e])
          : null;
      },
      enumerable: !0,
      configurable: !0,
              ...
              : Se({}, e, {
                  range: {
                    start: f.createMarker(
                      h.toDate(e.range.start, e.forcedStartTzo)
                    ),
                    end: f.createMarker(h.toDate(e.range.end, e.forcedEndTzo)),
                  },
                  forcedStartTzo: f.canComputeOffset ? null : e.forcedStartTzo,
                  forcedEndTzo: f.canComputeOffset ? null : e.forcedEndTzo,
                });
          })),
          { defs: v, instances: g }
        );
      ...
      !(
        ...
        !(function (e, t, n, r) {
          var i = e.eventDrag,
            ...
            s = o.defs,
            a = o.instances,
            l = gt(s, i.isEvent ? e.eventUiBases : { "": t.selectionConfig });
          r && (l = De(l, r));
          ...
          for (var h in a) {
            var f = a[h],
              ...
              g = l[f.defId],
              m = s[f.defId];
            if (!It(g.constraints, v, d, e.businessHours, t)) return !1;
            var y = t.opt("eventOverlap");
            for (var S in ("function" != typeof y && (y = null), u)) {
              var E = u[S];
              if (Ve(v, E.range)) {
                if (!1 === p[E.defId].overlap && i.isEvent) return !1;
                if (!1 === g.overlap) return !1;
                if (y && !y(new ut(t, c[E.defId], E), new ut(t, m, f)))
                  return !1;
              }
            }
            for (
              ...
              var T = D[w],
                C = Se({}, n, { range: f.range, allDay: m.allDay }),
                R = b.defs[m.defId],
                I = b.instances[h],
                k = void 0;
              if (
        ...
        !(
          ...
          !(function (e, t, n, r) {
            var i = e.eventStore,
              ...
              d = t.selectionConfig;
            r && (d = r(d));
            if (!It(d.constraints, l, i, e.businessHours, t)) return !1;
          ...
          (function (t, e, n, r, i) {
            {
              ...
              if ("object" == typeof t && t) return kt(xe(t, e, i));
            }
            return [];
          })(s[o], t, n, r, i),
          t
    ...
    var r,
      ...
      s =
        ...
        Array.isArray(r)
          ...
          : null);
    return {
      startEditable: null != o.startEditable ? o.startEditable : o.editable,
      durationEditable:
  ...
  function Gt(e, t, n, r) {
    ...
    var a,
      ...
      d = (function (e, t, n, r, i) {
        ...
        l && d && (d = V(d));
        s && ((u = s.marker), l && (u = V(u)), d && u <= d && (u = null));
        u
          ? (c = !0)
          : i ||
    ...
    return d
      ? {
          ...
          instance: At(a.defId, d.range, d.forcedStartTzo, d.forcedEndTzo),
        }
      : null;
  }
  function Ut(e, t, n, r, i) {
    var o,
      ...
      u =
        ...
        (l.ui = d),
        l);
    (u.defId = String(Ft++)), (u.sourceId = t), (u.allDay = n), (u.hasEnd = r);
    for (
  ...
  var qt = He(),
    Yt =
      ...
      (Xt.prototype._splitEventStore = function (e, t) {
        ...
        for (var l in r)
          for (var d, c = r[l], u = 0, p = t[c.defId]; u < p.length; u++)
  ...
  function Jt(e, t, n, r, i) {
    ...
    return (
      ...
      (i = i || ""),
      !a && e.navLinks
        ? "<a" + r + ' data-goto="' + xt(JSON.stringify(l)) + '">' + i + "</a>"
        : "<span" + r + ">" + i + "</span>"
    );
  }
  function Qt(e, t, n, r) {
      ...
      Ge(t.activeRange, e)
        ? (c.push("fc-" + H[e.getUTCDay()]),
          ...
          e < i
            ...
            : o <= e
            ? c.push("fc-future")
            : (c.push("fc-today"), !0 !== r && c.push(l.getClass("today"))))
  ...
  var nn,
    rn =
      ...
      (on.prototype.one = function (e, t) {
        return sn(this._oneHandlers || (this._oneHandlers = {}), e, t), this;
      }),
      ...
      (on.prototype.triggerWith = function (e, t, n) {
        return (
          ...
          this._oneHandlers &&
            (ce(this._oneHandlers[e], t, n), delete this._oneHandlers[e]),
          this
        );
      }),
  ...
  var ln =
    ...
    (dn.prototype.leftToIndex = function (e) {
      for (var t = this.lefts, n = this.rights, r = t.length, i = 0; i < r; i++)
        if (e >= t[i] && e < n[i]) return i;
    }),
    (dn.prototype.topToIndex = function (e) {
      for (var t = this.tops, n = this.bottoms, r = t.length, i = 0; i < r; i++)
        if (e >= t[i] && e < n[i]) return i;
    }),
  ...
  var yn,
    Sn =
      ...
      (En.prototype.applyOverflow = function () {
        f(this.el, { overflowX: this.overflowX, overflowY: this.overflowY });
      }),
  ...
  var kn,
    xn =
      ...
      (Mn.prototype.isInteractionValid = function (e) {
        ...
        if (n) for (var i in r) if (!Fe(n.validRange, r[i].range)) return !1;
        return Tt(e, t);
      }),
      (Mn.prototype.isDateSelectionValid = function (e) {
        var t = this.context.calendar,
          n = this.props.dateProfile;
        return (
          !(n && !Fe(n.validRange, e.range)) && Ct({ dateSelection: e }, t)
        );
      }),
    ...
    recurringTypes: [
      {
        parse: function (e, t, n) {
          ...
          if (a) {
            var d = null;
            return (
              "duration" in t && ((d = X(t.duration)), delete t.duration),
              !d &&
                s.startTime &&
                s.endTime &&
                ((r = s.endTime),
  ...
  var Jn =
    ...
    (Qn.prototype.compute = function () {
      var e = ue(
        ...
        t = ue(this.dynamicOverrides.locale, this.overrides.locale, An.locale),
        n = Yn(e),
        r = Xn(t || n.defaultCode, n.map).options,
        i =
          "rtl" === ue(this.dynamicOverrides.dir, this.overrides.dir, r.dir)
            ? Wn
            : {};
      (this.dirDefaults = i),
  ...
  var or =
    ...
    (sr.prototype.toDate = function (e, t) {
      return "local" === this.timeZone
        ...
        : this.namedTimeZoneImpl
        ? new Date(
            e.valueOf() - 1e3 * this.namedTimeZoneImpl.offsetForArray(A(e)) * 60
          )
  ...
  function fr(e, t, n, r) {
    ...
    for (var o in e) {
      ...
      t[o]
        ? (i[o] = (function (o, s, a) {
            var e = a.pluginSystem.hooks.eventSourceDefs[o.sourceDefId],
              l = String(pr++);
            return (
              e.fetch(
  ...
  var vr =
    ...
    (gr.prototype.buildRangeFromDuration = function (e, t, n, r) {
      ...
      function u() {
        (s = d.startOf(e, c)), (a = d.add(s, n)), (l = { start: s, end: a });
      }
      return (
        c ||
    ...
    (gr.prototype.buildRangeFromDayCount = function (e, t, n) {
      var r,
        ...
        a = e;
      for (
        o && (a = i.startOf(a, o)), a = V(a), r = a = this.skipHiddenDays(a, t);
    ...
    (gr.prototype.getRangeOption = function (e) {
      ...
      return (
        ...
        a &&
          ...
          (a = (!o && !s) || (o && s && s < o) ? null : { start: o, end: s })),
        (a = a && ve(a))
      );
    }),
        ...
        i = (function (e, t, n, r, i) {
          ...
          switch (t.type) {
            ...
            case "NEXT":
              ...
              break;
            case "SET_DATE":
              (e.activeRange && Ge(e.currentRange, t.dateMarker)) ||
        ...
        s = Se({}, e, {
          ...
          currentDate: (function (e, t, n) {
            switch (t.type) {
              case "PREV":
              case "NEXT":
                return Ge(n.currentRange, e) ? e : n.currentRange.start;
              case "SET_DATE":
              case "SET_VIEW_TYPE":
  ...
  function br(e, t, n, r) {
    ...
    var i = (function (e, t, n, r) {
      function i(e) {
        return o && null !== o[e] ? o[e] : s && null !== s[e] ? s[e] : null;
      }
      var o = n[e],
        s = r[e],
        a = i("class"),
      ...
      return a
        ? {
            ...
            overrides: Se({}, d ? d.overrides : {}, s ? s.options : {}),
          }
        : null;
    })(e, t, n, r);
    return i && (t[e] = i), i;
      ...
      function (e) {
        return (function (r, e, t) {
          ...
          return {
            ...
            buttonTextOverride:
              d(t.dynamicOverrides) || d(t.overrides) || r.overrides.buttonText,
            buttonTextDefault:
              d(t.localeDefaults) ||
              d(t.dirDefaults) ||
                ...
                "title" === e
                  ...
                  : ((n = m[e])
                      ? ((i = function (e) {
                        ...
                        (o = f.getCustomButtonIconClass(n)) ||
                          (o = f.getIconClass(e)) ||
                          (s = n.text))
                      : (r = g[e])
                      ...
                      : v[e] &&
                        ...
                        (s = y[e]) || (o = f.getIconClass(e)) || (s = S[e])),
                    i &&
                      ((l = ["fc-" + e + "-button", f.getClass("button")]),
                      s
                        ? ((a = xt(s)), (c = ""))
                        : o &&
                          ((a = "<span class='" + o + "'></span>"),
    ...
    Pr =
      ...
      (Hr.prototype._renderSkeleton = function (e) {
        this.updateElClassNames(e),
          m(
            this.el,
            (this.contentEl = s("div", { className: "fc-view-container" }))
          );
        for (
          var t = e.calendar,
            n = 0,
        ...
        (this.isHeightAuto = "auto" === n || "auto" === r),
          "number" == typeof r
            ...
            ? ((e = this.el.parentNode),
              (this.viewHeight =
                e.getBoundingClientRect().height - this.queryToolbarsHeight()))
      ...
      (n.removeHoverListeners =
        ...
        M(t, "mouseover", r, function (e, t) {
          ...
          t !== s &&
            (i(e, (s = t)),
            (n = function (e) {
              (s = null), o(e, t), t.removeEventListener("mouseleave", n);
            }),
  ...
  var Yr =
              ...
              "string" == typeof o
                ? ((i = "FullCalendar" + ae(o)),
                  window[i]
                    ...
                    : console.warn("Plugin file not loaded for " + o))
                : t.push(o);
            }
            return Zn.concat(t);
          })(e);
    ...
    (Xr.prototype.bindHandlers = function () {
      ...
      (this.removeNavLinkListener = M(
        ...
        "a[data-goto]",
        function (e, t) {
          var n = (n = t.getAttribute("data-goto")) ? JSON.parse(n) : {},
            r = a.dateEnv,
    ...
    (Xr.prototype.mutateOptions = function (e, t, n, r) {
      ...
      this.optionsManager.mutate(s, t, n),
        ...
        this.batchRendering(function () {
          if (
            (u
              ? (d && i.dispatch({ type: "CHANGE_TIMEZONE", oldDateEnv: l }),
                i.dispatch({
                  type: "SET_VIEW_TYPE",
    ...
    (Xr.prototype.getDefaultEventEnd = function (e, t) {
      var n = t;
      return (n = e
        ? ((n = V(n)), this.dateEnv.add(n, this.defaultAllDayEventDuration))
  ...
  function Qr(e) {
    return new (this.pluginSystem.hooks.themeClasses[e.themeSystem] || Zr)(e);
  }
  function $r(e) {
  ...
  var ni,
    ri =
      ...
      (ii.prototype.renderDatesWrap = function (e) {
        this.renderDates(e),
          this.addScroll({ duration: X(this.context.options.scrollTime) });
      }),
      ...
      (ii.prototype.startNowIndicator = function (e, t) {
        ...
        s.options.nowIndicator &&
          ...
          (i =
            l.add(l.startOf(this.initialNowDate, n), X(1, n)).valueOf() -
    ...
    (si.prototype._getTimeText = function (e, t, n, r, i, o, s) {
      ...
      return (
        ...
        this.displayEventTime && !n
          ? i && t
            ? a.formatRange(e, t, r, { forcedStartTzo: o, forcedEndTzo: s })
    ...
    var l = o.dateEnv,
      ...
      h =
        "function" == typeof c.columnHeaderHtml
          ...
          : xt(l.format(e, i));
    return (
      n ? (p = p.concat(Qt(e, t, o, !0))) : p.push("fc-" + H[e.getUTCDay()]),
      '<th class="' +
        p.join(" ") +
        '"' +
        (u && n
  ...
  var Ci =
    ...
    (Ri.prototype.sliceNowDate = function (e, t) {
      ...
      return this._sliceDateSpan.apply(
        this,
        [{ range: { start: e, end: O(e, 1) }, allDay: !1 }, {}, t].concat(n)
      );
    }),
      ...
      for (
        var o,
          ...
          d =
            ...
            {
              def: (l = Ut({ editable: !1 }, "", o.allDay, !0, a)),
              ui: mt(l, s),
  ...
  (e.Calendar = Yr),
    ...
    (e.compensateScroll = function (e, t) {
      t.left && f(e, { borderLeftWidth: 1, marginLeft: t.left - 1 }),
        t.right && f(e, { borderRightWidth: 1, marginRight: t.right - 1 });
    }),
      ...
      return (
        e.forEach(function (e) {
          ...
          n instanceof HTMLElement &&
            ((t = n.getBoundingClientRect().width), r < t && (r = t));
        }),
        r++,
        e.forEach(function (e) {
          e.style.width = r + "px";
        ...
        (i.prototype.buildRenderRange = function (e, t, n) {
          ...
          return (
            ...
            this.options.monthMode &&
              ...
              ((i = Math.ceil(R.diffWeeks(a, l))), (l = R.addWeeks(l, 6 - i))),
            { start: a, end: l }
          );
        }),
        i);
      ...
      a =
        ...
        (l.prototype.renderSegHtml = function (e, t) {
          var n,
            ...
            c = l && e.isStart && R.computeEventStartResizable(i, s, a),
          ...
          return (
            ...
            e.isStart &&
              ...
              (f = '<span class="fc-time">' + R.htmlEscape(n) + "</span>"),
            (r =
              '<span class="fc-title">' +
    ...
    var u,
      p =
        ...
        (h.prototype.renderSegRows = function (e) {
          for (var t = [], n = this.groupSegRows(e), r = 0; r < n.length; r++)
        ...
        (h.prototype.renderSegRow = function (e, t) {
          ...
          for (n = 0; n < h; n++) {
            ...
            b && (d ? R.appendToElement(o, b) : R.prependToElement(o, b)),
              f.appendChild(o);
          }
          return {
            row: e,
        ...
        (h.prototype.groupSegRows = function (e) {
          for (var t = [], n = 0; n < this.dayGrid.rowCnt; n++) t.push([]);
          ...
          this.dayGrid.rowEls.forEach(function (e, t) {
            var n = R.htmlToElement(
              ...
              r =
                o && o.row === t
                  ? o.el
                  : (r = e.querySelector(".fc-content-skeleton tbody")) ||
                    e.querySelector(".fc-content-skeleton table"),
              i = r.getBoundingClientRect().top - e.getBoundingClientRect().top;
            (n.style.top = i + "px"),
      ...
      b =
        ...
        (w.prototype.renderFillRow = function (e, t) {
          ...
          0 < o && R.appendToElement(d, new Array(o + 1).join(E)),
            (t.el.colSpan = s - o),
            d.appendChild(t.el),
            s < i && R.appendToElement(d, new Array(i - s + 1).join(E));
          var c = n.renderProps.renderIntroHtml();
          return (
            c && (r ? R.appendToElement(d, c) : R.prependToElement(d, c)), l
          );
        }),
        w);
    function w(e) {
        ...
        for (
          ...
          t.push(
            ...
            '<td class="' +
              ...
              '"' +
              (l
                ? ' data-date="' + s.formatIso(n, { omitTime: !0 }) + '"'
                : "") +
              (o ? " " + o : "") +
              "></td>")
          );
      ...
      z =
        ...
        (N.prototype.renderNumberCellHtml = function (e) {
          var t,
            ...
            o = r.options,
            s = "",
            a = R.rangeContainsMarker(this.props.dateProfile.activeRange, e),
          ...
          return l || this.renderProps.cellWeekNumbersVisible
            ? ((t = R.getDayClasses(
              ...
              this.renderProps.cellWeekNumbersVisible && (n = i.weekDow),
              (s +=
                '<td class="' +
                t.join(" ") +
                '"' +
                (a
                  ? ' data-date="' + i.formatIso(e, { omitTime: !0 }) + '"'
                  : "") +
                ">"),
              this.renderProps.cellWeekNumbersVisible &&
                e.getUTCDay() === n &&
          ...
          for (
            ...
            this.unlimitRow(r),
              !1 !==
                (t =
                  !!e &&
                  ("number" == typeof e ? e : this.computeRowLevelLimit(r))) &&
                this.limitRow(r, t);
        }),
        (N.prototype.computeRowLevelLimit = function (e) {
          for (
            var t,
              ...
              r = R.findChildren(this.eventRenderer.rowStructs[e].tbodyEl),
              i = 0;
            i < r.length;
            i++
          )
        ...
        (N.prototype.limitRow = function (t, n) {
          ...
          if (n && n < b.segLevels.length) {
            for (
              r = b.segLevels[n - 1],
                i = b.cellMatrix,
                (o = R.findChildren(b.tbodyEl).slice(n)).forEach(function (e) {
              ...
              if (d) {
                for (
                  ...
                  (v = R.createElement("td", {
                    ...
                    (l = c[f]),
                    (m = this.renderMoreLink(t, T + f, [a].concat(l))),
                    (g = R.createElement("div", null, m)),
                    v.appendChild(g),
                    h.push(v),
                    w.push(v);
        ...
        (N.prototype.unlimitRow = function (e) {
          ...
          t.moreEls && (t.moreEls.forEach(R.removeElement), (t.moreEls = null)),
            t.limitedEls &&
        ...
        (N.prototype.showSegPopover = function (t, e, n, r) {
          var i = this,
            ...
            h = {
              className: "fc-more-popover " + l.getClass("popover"),
              parentEl: a.el,
              top: R.computeRect(p).top,
              autoHide: !0,
              content: function (e) {
                (i.segPopoverTile = new T(e)),
                  i.updateSegPopoverTile(i.props.cells[t][c].date, r);
              },
              hide: function () {
        ...
        (N.prototype.resliceDaySegs = function (e, t) {
          for (
            var n = { start: t, end: R.addDays(t, 1) }, r = [], i = 0, o = e;
            i < o.length;
            i++
          ) {
            var s = o[i],
            ...
            d &&
              r.push(
                c({}, s, {
                  eventRange: {
                    def: a.def,
                    ui: c({}, a.ui, { durationEditable: !1 }),
                    instance: a.instance,
                    range: d,
                  },
                  isStart: s.isStart && d.start.valueOf() === l.start.valueOf(),
                  isEnd: s.isEnd && d.end.valueOf() === l.end.valueOf(),
                })
              );
          }
          return r;
    ...
    var L,
      ...
      V =
        ...
        (F.prototype.destroy = function () {
          L.prototype.destroy.call(this), this.renderSkeleton.unrender();
        }),
        (F.prototype._renderSkeleton = function (e) {
          this.el.classList.add("fc-dayGrid-view"),
            (this.el.innerHTML = this.renderSkeletonHtml()),
            (this.scroller = new R.ScrollComponent("hidden", "auto"));
        ...
        (F.prototype.updateBaseSize = function (e, t, n) {
          ...
          o.rowEls
            ...
            : n ||
              ((r = this.computeScrollerHeight(t)), this.scroller.setHeight(r));
        }),
        (F.prototype.computeScrollerHeight = function (e) {
          return e - R.subtractInnerElHeight(this.el, this.scroller.el);
        }),
    ...
    function F() {
      ...
      return (
          ...
          return s.colWeekNumbersVisible
            ? '<td class="fc-week-number" ' +
                ...
                R.buildGotoAnchorHtml(
                  r,
                  i,
                  { date: o, type: "week", forceOff: 1 === t.colCnt },
                  i.format(o, B)
                ) +
                "</td>"
            : "";
        ...
        (s.renderDayGridIntroHtml = function () {
          return s.colWeekNumbersVisible
            ? '<td class="fc-week-number" ' + s.weekNumberStyleAttr() + "></td>"
            : "";
        }),
        s
      );
          ...
          n.receiveContext(t),
            n.receiveProps(
              c(
                ...
                { dateProfile: r, cells: i.cells, isRigid: e.isRigid }
              ),
              t
            );
        }),
      ...
      Y =
        ...
        (X.prototype.render = function (e, t) {
          ...
          var n = this.props.dateProfile,
            r = (this.dayTable = this.buildDayTable(n, e.dateProfileGenerator));
          this.header &&
        ...
        (o.prototype.renderSegHtml = function (e) {
          var t = this.context,
            ...
            u = o.allDay
              ...
              ? e.isStart
                ? p.htmlEscape(this._getTimeText(s.range.start, e.end, !1))
                : e.isEnd
                ? p.htmlEscape(this._getTimeText(e.start, s.range.end, !1))
                : p.getAllDayHtml(r)
      ...
      a =
        ...
        (l.prototype.render = function (e, t) {
          ...
          (this.dayDates = r),
            ...
            this.renderContent(
              t,
              this.eventStoreToSegs(e.eventStore, e.eventUiBases, i)
            );
        }),
        ...
        (l.prototype._renderSkeleton = function (e) {
          ...
          for (
            var n = 0, r = (t.getClass("listView") || "").split(" ");
            n < r.length;
            n++
          ) {
            var i = r[n];
        ...
        (l.prototype.updateSize = function (e, t, n) {
          s.prototype.updateSize.call(this, e, t, n),
            ...
            this.scroller.clear(),
            n || this.scroller.setHeight(this.computeScrollerHeight(t));
        }),
        (l.prototype.computeScrollerHeight = function (e) {
          return e - p.subtractInnerElHeight(this.el, this.scroller.el);
        }),
        ...
        (l.prototype.renderSegList = function (e) {
          for (
            ...
            if ((t = i[a]))
              for (
                s.appendChild(this.buildDayHeaderRow(this.dayDates[a])),
        ...
        (l.prototype.buildDayHeaderRow = function (e) {
          ...
          return p.createElement(
            ...
            '<td class="' +
              (n.getClass("tableListHeading") || n.getClass("widgetHeader")) +
              '" colspan="3">' +
              (o
      ...
      s =
        ...
        (n.prototype.computeSegSizes = function (e) {
          ...
          if ((t.computeSegVerticals(e), n))
            for (var i = 0; i < r; i++) this.computeSegHorizontals(n[i]);
        }),
        ...
        (n.prototype.renderSegHtml = function (e, t) {
          var n,
            ...
            p = e.isStart && g.computeEventStartResizable(this.context, l, d),
            h = e.isEnd && g.computeEventEndResizable(this.context, l, d),
          ...
          return (
            ...
            g.isMultiDayRange(a.range)
              ? (e.isStart || e.isEnd) &&
                ...
                (o = this._getTimeText(n, r, c, this.fullTimeFormat)),
            ...
            '<a class="' +
              ...
              (i
                ...
                : "") +
              (l.title
                ? '<div class="fc-title">' + g.htmlEscape(l.title) + "</div>"
                : "") +
              "</div>" +
              ...
              !(function e(t) {
                ...
                if (void 0 === t.forwardPressure) {
                  for (n = 0; n < i.length; n++)
                    (r = i[n]), e(r), (o = Math.max(o, 1 + r.forwardPressure));
                  t.forwardPressure = o;
                }
              })(t[n]);
            for (n = 0; n < t.length; n++)
        ...
        (n.prototype.assignSegCss = function (e) {
          for (var t = 0, n = e; t < n.length; t++) {
            ...
            g.applyStyle(r.el, this.generateSegCss(r)),
              0 < r.level && r.el.classList.add("fc-time-grid-event-inset"),
      ...
      S =
        ...
        (E.prototype.computeLabelInterval = function (e) {
          for (var t, n, r = y.length - 1; 0 <= r; r--)
            if (
              ...
              null !== (n = g.wholeDivideDurations(t, e)) && 1 < n)
            )
              return t;
          return e;
        }),
        ...
        (E.prototype._renderSlats = function (e) {
          ...
          (this.slatContainerEl.innerHTML =
            ...
            "</table>"),
            (this.slatEls = g.findElements(this.slatContainerEl, "tr")),
        ...
        (E.prototype.renderSlatRowHtml = function (e) {
          for (
            ...
            (t = o.add(d, c)),
              (n = null !== g.wholeDivideDurations(u, this.labelInterval)),
              (r =
                ...
                (n
                  ? "<span>" +
                    g.htmlEscape(o.format(t, this.labelFormat)) +
                    "</span>"
                  : "") +
                "</td>"),
              (l +=
        ...
        (E.prototype._renderColumns = function (e, t) {
          ...
          for (var d = 0; d < this.colCnt; d++)
            r.publiclyTrigger("dayRender", [
              { date: a.toDate(e[d].date), el: this.colEls[d], view: i },
            ]);
        ...
        (E.prototype.renderContentSkeleton = function () {
          ...
          t && n.reverse(),
            ...
            (this.colContainerEls = g.findElements(e, ".fc-content-col")),
            ...
            (this.bgContainerEls = g.findElements(e, ".fc-bgevent-container")),
        ...
        (E.prototype.attachSegsByCol = function (e, t) {
          for (var n, r, i = 0; i < this.colCnt; i++)
            for (n = e[i], r = 0; r < n.length; r++) t[i].appendChild(n[r].el);
        }),
        ...
        (E.prototype.computeDateTop = function (e, t) {
          return (
            (t = t || g.startOfDay(e)),
            this.computeTimeTop(g.createDuration(e.valueOf() - t.valueOf()))
          );
        }),
        ...
        (E.prototype.computeSegVerticals = function (e) {
          for (
            var t, n, r = this.context.options.timeGridEventMinHeight, i = 0;
            i < e.length;
            i++
          )
            (t = e[i]),
              ...
              (t.bottom = Math.max(t.top + r, this.computeDateTop(t.end, n)));
        }),
        (E.prototype.assignSegVerticals = function (e) {
          for (var t, n = 0; n < e.length; n++)
            (t = e[n]), g.applyStyle(t.el, this.generateSegVerticalCss(t));
        }),
        ...
        (E.prototype.positionToHit = function (e, t) {
          ...
          if (null != s && null != a) {
            ...
            return {
              col: s,
              dateSpan: {
                range: { start: f, end: n.add(f, this.snapDuration) },
                allDay: !1,
              },
              dayEl: this.colEls[s],
              relativeRect: {
      ...
      R =
        ...
        (I.prototype._renderSkeleton = function (e) {
          this.el.classList.add("fc-timeGrid-view"),
            (this.el.innerHTML = this.renderSkeletonHtml()),
            (this.scroller = new g.ScrollComponent("hidden", "auto"));
          var t = this.scroller.el;
          this.el.querySelector(".fc-body > tr > td").appendChild(t),
            t.classList.add("fc-time-grid-container");
          var n,
            r = g.createElement("div", { className: "fc-time-grid" });
          t.appendChild(r),
        ...
        (I.prototype.updateBaseSize = function (e, t, n) {
          ...
          (this.axisWidth = g.matchCellWidths(
            ...
            this.timeGrid.colEls
              ? ((s = g.findElements(this.el, ".fc-row").filter(function (e) {
        ...
        (I.prototype.computeScrollerHeight = function (e) {
          return e - g.subtractInnerElHeight(this.el, this.scroller.el);
        }),
            ...
            ? ((e = r.format(o.start, C)),
              '<th class="fc-axis fc-week-number ' +
                ...
                g.buildGotoAnchorHtml(
                  i,
                  r,
                  { date: o.start, type: "week", forceOff: 1 < s },
                  g.htmlEscape(e)
                ) +
                "</th>")
            : '<th class="fc-axis ' +
    ...
    var k,
      x =
        ...
        (M.prototype.render = function (e, t) {
          ...
          s.receiveContext(t),
            s.receiveProps(
              l({}, this.slicer.sliceProps(e, r, null, t.calendar, s, o), {
                dateProfile: r,
                cells: i.cells[0],
              }),
              t
      ...
      N =
        ...
        (L.prototype._renderSkeleton = function (e) {
          z.prototype._renderSkeleton.call(this, e),
            ...
            this.dayGrid &&
              (this.simpleDayGrid = new c.SimpleDayGrid(this.dayGrid));
        }),
        (L.prototype._unrenderSkeleton = function () {
